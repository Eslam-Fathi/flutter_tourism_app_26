...
String _$chatNotifierHash() => r'39cb90e3a7a5136e6397169d7b843e2a0cae95a3';
...
abstract class _$ChatNotifier
  ...
  FutureOr<List<ChatMessage>> build(String bookingId);
}
...
class ChatNotifierFamily extends Family<AsyncValue<List<ChatMessage>>> {
  ...
  /// See also [ChatNotifier].
  ChatNotifierProvider call(String bookingId) {
    return ChatNotifierProvider(bookingId);
  }
...
class ChatNotifierProvider
  ...
  /// See also [ChatNotifier].
  ChatNotifierProvider(String bookingId)
    : this._internal(
        () => ChatNotifier()..bookingId = bookingId,
  ...
  bool operator ==(Object other) {
    return other is ChatNotifierProvider && other.bookingId == bookingId;
  }
...
class _ChatNotifierProviderElement
  ...
  @override
  String get bookingId => (origin as ChatNotifierProvider).bookingId;
}
